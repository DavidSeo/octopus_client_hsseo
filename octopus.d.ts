...
export declare function compare_service(aA: TService, aB: TService): boolean;
...
export declare class CMediaPlay extends CDBusInterface {
    constructor();
...
export declare class CMetaService extends CDBusInterface {
    constructor();
